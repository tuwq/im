...
import root.async.PushNewPullDataHandler;
...
public class SingleRequestService {
	...
	@Resource
	private PushNewPullDataHandler pushNewPullDataHandler;
	...
	public void send(SendSingleRequestParam param) {
		...
		pushNewPullDataHandler.pullNewSingleRequest(acceptId);
	}
	/**
	 * 该用户接收的好友请求
	 * 检查参数
	...
	public void agree(AcceptSingleRequestParam param) {
		...
		pushNewPullDataHandler.pullNewContact(sendId);
	}
