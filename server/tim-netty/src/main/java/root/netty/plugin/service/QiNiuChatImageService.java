package root.netty.plugin.service;
...
@Service
public class QiNiuChatImageService {
	 ...
	 * @param userId
	 */
	public String senderChatImage(byte[] uploadBytes, String fileName) {
		String key = timConfigProperties.getQiniu().getChatImagePrefix() + fileName;
