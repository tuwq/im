...
CREATE TABLE `friend_request` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '好友请求关联id',
...
CREATE TABLE `group_chat_msg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '组消息id',
  `send_user_id` int(11) NOT NULL COMMENT '发送者id',
...
CREATE TABLE `group_request` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '组请求关联id',
...
CREATE TABLE `group_users` (
  `id` int(11) NOT NULL COMMENT '组用户关联id',
...
CREATE TABLE `my_friends` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '好友关联id',
...
CREATE TABLE `private_chat_msg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '私人信息id',
  `send_user_id` int(11) NOT NULL COMMENT '发送者id',
  `accept_user_id` int(11) NOT NULL COMMENT '接收者id',
  `msg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消息内容',
  `sign_flag` int(11) NOT NULL COMMENT '是否签收',
...
CREATE TABLE `users` (
  ...
  `account_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '账号(qq号)',
...
CREATE TABLE `user_message_sign_flag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '消息可靠id',
